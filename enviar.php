...
echo "<script>alert('Los campos marcados con * son obligatorios');location.href ='javascript:history.back()';</script>";
    ...
    $mail->AddAddress("andriusmw@gmail.com"); // Dirección a la que llegaran los mensajes.
...
// Datos del servidor SMTP, podemos usar el de Google, Outlook, etc...
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "andriusmw@gmail.com";  // Correo Electrónico
    $mail->Password = "Charizard006-1208"; // Contraseña del correo
